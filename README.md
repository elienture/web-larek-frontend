...
- ```buttonState``` - состояние кнопки покупки товара
...
- ```buttonState``` - защищенное свойство, меняет текстовое содержимое кнопки, "В корзину" или "Удалить из корзины"
...
- ```set/get buttonState``` - устанавливает текстовое содержимое кнопки
